        ...
        <div className="max-w-4xl mx-auto px-6 lg:px-12 py-8 lg:py-12">
            <div className="max-w-4xl mx-auto px-6 lg:px-12 py-8 lg:py-12">
                ...
                <div className="prose prose-invert max-w-none text-base lg:text-lg leading-relaxed text-gray-200 space-y-4">
                        ...
                        <p>Once a unique simulation Id is created, the back-end then creates an EventEmitter in order to stream data to the front-end that the generated Python process calculates during a given simulation run. The state lifecycle is updated from events received from the EventEmitter, and all necessary clean-up functions are initiated if the simulation runs into an error or is  manually reset.</p>
                        <p>The simulation runs within a for-loop with step-increments of milliseconds which differs from the original program in the paper, which ran in increments of 1 second above a certain altitude and then increments of 0.1 seconds once air resistance became a more significant factor on the total forces acting on the missile. Given that computation speeds have somewhat improved since 1962, a modern Python application is adept at dealing with a higher fidelity simulation.
                        Once the simulation concludes, the Python process terminates and the clean-up process occurs.</p>
                </div>
            </div>
        </div>
    );
